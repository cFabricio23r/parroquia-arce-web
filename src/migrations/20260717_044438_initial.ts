...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('super-admin', 'contenido', 'comunicaciones');
  CREATE TYPE "public"."enum_news_category" AS ENUM('aviso', 'comunicado', 'celebracion', 'pastoral', 'emergencia');
  ...
  CREATE TABLE "users" (
  	...
  	"name" varchar,
  	"role" "enum_users_role" DEFAULT 'contenido' NOT NULL,
