...
export function MiniNews({ item }: { item: News }) {
  return (
    <Link
      ...
      className="grid grid-cols-[auto_1fr] items-center gap-4 rounded-lg border border-border bg-white p-[18px_20px] transition-[transform,box-shadow,border-color] duration-200 hover:-translate-y-0.5 hover:border-line-soft hover:shadow-md max-[600px]:grid-cols-1"
    >
